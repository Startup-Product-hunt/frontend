const TicketCard = ({ event, ticketNumber, issuedAt }) => {
  // if no event, show fallback
  if (!event) {
    return (
      <div className="border border-gray-300 rounded-lg p-4 bg-white shadow-md">
        <h2 className="text-xl font-bold text-gray-800 mb-2">Event not available</h2>
  ...
  return (
    <div className="border border-gray-300 rounded-lg p-4 bg-white shadow-md hover:shadow-lg transition">
      ...
      <p className="text-gray-500 text-sm mb-2">
        <span className="font-medium">Location:</span> {event.location}</p>
